    ...
    <section className="relative min-h-[50vh] flex items-center justify-center px-6 py-24 overflow-hidden bg-slate-950 border-b border-slate-900/50">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 text-center">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-3xl sm:text-6xl font-black tracking-wide break-words [text-wrap:balance] bg-gradient-to-r from-white via-sky-100 to-sky-300 bg-clip-text text-transparent"
          >
            {t('title')}
          </motion.h1>
