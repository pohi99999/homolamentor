            ...
            {status === 'success' ? (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={status === 'loading'}
                  className="w-full mt-4 px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-400 disabled:from-emerald-600/50 disabled:to-teal-500/50 text-slate-950 font-bold rounded-xl shadow-lg shadow-emerald-500/15 hover:shadow-emerald-500/25 hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2 disabled:scale-100 disabled:cursor-not-allowed cursor-pointer"
                >
                  {status === 'loading' ? (
                    <>
