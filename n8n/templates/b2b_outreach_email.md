# HOMLAMENTOR KFT - B2B Outreach Email Templates

This document contains B2B cold outreach templates in Hungarian, English, and German. These templates pitch the West African market and office expansion opportunities through the HOMLAMENTOR KFT Abidjan hub.

Variables to replace dynamically in n8n (using `{{ $json.name }}`, `{{ $json.company }}`, `{{ $json.industry }}`):
- `[Keresztnév / Contact Name]`
- `[Cégnév / Company Name]`
- `[Iparág / Industry]`
...
**Tárgy:** Afrikai piacnyitás és megbízások felkutatása a(z) [Cégnév] részére – HOMLAMENTOR KFT

Tisztelt [Keresztnév / Kapcsolattartó]!

Azért fordulok Önhöz, mert a(z) [Cégnév] tevékenysége a(z) [Iparág] szektorban kiemelkedő, és úgy látjuk, hogy az Önök technológiája és szakértelme hatalmas versenyelőnyt jelenthetne a dinamikusan fejlődő nyugat-afrikai piacokon.
...
Szeretnénk felajánlani egy rövid, 15 perces online konzultációt, ahol bemutatjuk a jelenleg elérhető konkrét afrikai projektlehetőségeket és megbízásokat a(z) [Iparág] területén.
...
**Subject:** African market expansion and project acquisition for [Company Name] – HOMLAMENTOR KFT

Dear [Contact Name],

I am reaching out because of [Company Name]'s outstanding position in the [Industry] sector. We believe your technology and expertise would represent a massive competitive advantage in the rapidly growing markets of West Africa.
...
We would like to invite you to a brief, 15-minute online consultation to present concrete project opportunities and tenders currently available in West Africa within the [Industry] field.
...
## 3. Német verzió (German)

**Betreff:** Afrikanische Marktexpansion und Projektaquisition für [Unternehmensname] – HOMLAMENTOR KFT

Sehr geehrte(r) Frau/Herr [Kontaktname],

ich wende mich an Sie, da die Aktivitäten von [Unternehmensname] im Sektor [Branche] äußerst vielversprechend sind. Wir sind davon überzeugt, dass Ihre Technologie und Expertise auf den dynamisch wachsenden Märkten Westafrikas einen erheblichen Wettbewerbsvorteil darstellen würden.
...
Wir möchten Sie zu einer kurzen, 15-minütigen Online-Konsultation einladen, um Ihnen konkrete Projektmöglichkeiten und Ausschreibungen vorzustellen, die derzeit in Westafrika im Bereich [Branche] verfügbar sind.
